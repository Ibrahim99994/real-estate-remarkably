...
export async function runGeneration(data: ListingFacts): Promise<ListingResult> {
  ...
  try {
    ...
    throw new Error(err instanceof Error ? err.message : "Generation failed. Please try again.");
  }
}
